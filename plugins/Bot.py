...
@sree.on_message(filters.command('passgen'))
...
## Reply keyboard {10}
@sree.on_message(filters.regex('passgen1') & filters.private)
...
@sree.on_message(filters.regex('passgen2') & filters.private)
...
@sree.on_message(filters.regex('passgen3') & filters.private)
...
@sree.on_message(filters.regex('passgen4') & filters.private)
...
@sree.on_message(filters.regex('passgen5') & filters.private)
...
@sree.on_message(filters.regex('passgen6') & filters.private)
...
@sree.on_message(filters.regex('passgen7') & filters.private)
...
@sree.on_message(filters.regex('passgen8') & filters.private)
...
@sree.on_message(filters.regex('passgen9') & filters.private)
...
@sree.on_message(filters.regex('passgen10') & filters.private)
