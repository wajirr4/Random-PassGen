...
async def randompass6(sree, m: Message):
    ...
    P = ''.join(random.choice(Pass) for _ in range(10))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass6")]]))
...
async def randompass7(sree, m: Message):
    ...
    P = ''.join(random.choice(Pass) for _ in range(10))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass7")]]))
...
async def randompass8(sree, m: Message):
    ...
    P = ''.join(random.choice(Pass) for _ in range(10))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass8")]]))
...
async def randompass9(sree, m: Message):
    ...
    P = ''.join(random.choice(Pass) for _ in range(10))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass9")]]))
...
async def randompass10(sree, m: Message):
    ...
    P = ''.join(random.choice(Pass) for _ in range(10))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass10")]]))
...
async def randompass11(sree, m: Message):
    ...
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass11")]]))
...
async def randompass12(sree, m: Message):
    ...
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass12")]]))
...
async def randompass13(sree, m: Message):
    ...
    Pass = string.ascii_letters + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass13")]]))
...
async def randompass14(sree, m: Message):
    ...
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass14")]]))
...
async def randompass15(sree, m: Message):
    ...
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass15")]]))
...
async def randompass16(sree, m: Message):
    ...
    Pass = string.ascii_lowercase + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass16")]]))
...
async def randompass17(sree, m: Message):
    ...
    Pass = string.ascii_uppercase + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass17")]]))
...
async def randompass18(sree, m: Message):
    ...
    Pass = string.ascii_lowercase + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass18")]]))
...
async def randompass19(sree, m: Message):
    ...
    Pass = string.ascii_uppercase + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass19")]]))
...
async def randompass20(sree, m: Message):
    ...
    Pass = string.punctuation + string.digits
    P = ''.join(random.choice(Pass) for _ in range(6))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass20")]]))
...
async def randompass21(sree, m: Message):
    ...
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass21")]]))
...
async def randompass22(sree, m: Message):
    ...
    Pass = string.ascii_letters + string.punctuation 
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass22")]]))
...
async def randompass23(sree, m: Message):
    ...
    Pass = string.ascii_letters + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass23")]]))
...
async def randompass24(sree, m: Message):
    ...
    Pass = string.ascii_uppercase + string.digits
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass24")]]))
...
async def randompass25(sree, m: Message):
    ...
    Pass = string.ascii_lowercase + string.digits
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass25")]]))
...
async def randompass26(sree, m: Message):
    ...
    Pass = string.ascii_lowercase + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass26")]]))
...
async def randompass27(sree, m: Message):
    ...
    Pass = string.ascii_uppercase + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass27")]]))
...
async def randompass28(sree, m: Message):
    ...
    Pass = string.ascii_lowercase + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass28")]]))
...
async def randompass29(sree, m: Message):
    ...
    Pass = string.ascii_uppercase + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass29")]]))
...
async def randompass30(sree, m: Message):
    ...
    Pass = string.punctuation + string.digits
    P = ''.join(random.choice(Pass) for _ in range(8))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass30")]]))
...
async def randompass31(sree, m: Message):
    ...
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass31")]]))
...
async def randompass32(sree, m: Message):
    ...
    Pass = string.ascii_letters + string.punctuation 
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass32")]]))
...
async def randompass33(sree, m: Message):
    ...
    Pass = string.ascii_letters + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass33")]]))
...
async def randompass34(sree, m: Message):
    ...
    Pass = string.ascii_uppercase + string.digits
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass34")]]))
...
async def randompass35(sree, m: Message):
    ...
    Pass = string.ascii_lowercase + string.digits
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass35")]]))
...
async def randompass36(sree, m: Message):
    ...
    Pass = string.ascii_lowercase + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass36")]]))
...
async def randompass37(sree, m: Message):
    ...
    Pass = string.ascii_uppercase + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass37")]]))
...
async def randompass38(sree, m: Message):
    ...
    Pass = string.ascii_lowercase + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass38")]]))
...
async def randompass39(sree, m: Message):
    ...
    Pass = string.ascii_uppercase + string.digits + string.punctuation
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass39")]]))
...
async def randompass40(sree, m: Message):
    ...
    Pass = string.punctuation + string.digits
    P = ''.join(random.choice(Pass) for _ in range(12))
    await msgg.edit_text(f"<b><u>Your Password is Generated Successfully✅</u>\n\nPassword</b>:- <code>{P}</code>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Change Password", callback_data="chngpass40")]]))
