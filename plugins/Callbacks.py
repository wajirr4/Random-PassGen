...
async def close_(Client, cb: CallbackQuery):
    ...
    if cb.data == "close_":
        ...
        await cb.message.edit_text(helptxt.format(nm, BOT_USERNAME, BOT_USERNAME, BOT_USERNAME), reply_markup=InlineKeyboardMarkup(homebtn), disable_web_page_preview=True)
